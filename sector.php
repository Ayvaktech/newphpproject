			...
			<section class="brows-job-category">
				<div class="container">
					...
					<div class="item-click">
                     <?php                        
                  $id=$_GET['id'];
                         $sql=mysqli_query($con,"select * from job_reg where jobtitle='$id' OR city='$id' OR cname='$id' OR pos='$id' ");
                    ...
                    ?>
						<article>
							...
							<div class="brows-job-list">
								<div class="col-md-1 col-sm-2 small-padding">
									<div class="brows-job-company-img">
										<a href=""><img src="upload/<?php echo $row['img_filename']; ?>" class="img-responsive" alt="" /></a>
									</div>
								</div>
								<div class="col-md-5 col-sm-5">
									<div class="brows-job-position">
										<a href=""><h3><?php   echo $row['cname'];  ?></h3></a>
										<p>
											<span></span><span class="brows-job-sallery"><i class="fa fa-money"></i><?php   echo $row['salary'];  ?></span>
											<span class="job-type cl-success bg-trans-success"><?php   echo $row['pos'];  ?></span>
										</p>
									</div>
								</div>
								...
								<div class="col-md-1 col-sm-1">
									<div class="brows-job-link">
										<a name="details" href="JobDetails.php?id=<?php echo $row['job_id']; ?>" class="btn btn-success">Details</a>
									</div>
								</div>
								<!--<div class="col-md-1 col-sm-1">
									<div class="brows-job-link">
							...
							<span class="tg-themetag tg-featuretag"><?php   echo $row['jobtitle'];  ?></span>
						</article>
						<?php
						}
