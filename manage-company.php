			...
			<section class="manage-company gray">
				<div class="container">
					...
					<div class="row">
						<div class="col-md-12">
							<?php 
							     $sql=mysqli_query($con,"select * from comp_reg ");
							...
							<div class="brows-job-list">
								...
								<div class="col-md-5 col-sm-5">
									<div class="brows-job-position">
										<a href=""><h3><?php echo $row1['cname'];  ?></h3></a>
										<p>
											<span></span><span class="brows-job-sallery"><i class="fa fa-money"></i><?php   echo $row1['number'];  ?></span>
											<span class="job-type cl-success bg-trans-success"><?php   echo $row1['business'];  ?></span>
										</p>
									</div>
								</div>
								<div class="col-md-2 col-sm-2">
									<div class="brows-job-location">
										<p><i class="fa fa-map-marker"></i><?php   echo $row1['address'];  ?></p>
									</div>
								</div>
								
								<div class="col-md-1 col-sm-1">
									<div class="brows-job-link">
										<a href="delete_company.php?id=<?php echo $row1['com_id']; ?>">&nbsp;&nbsp;<i class="fa fa-trash-o"></i></a>
