                  ...
                  <div class="row text-center" >
                     ...
                     <div class="row" >
                        <div class="col-sm-1">
                         ...
                         <div class="col-sm-10" id="amt1" style="background: #f3f1f2;font-size: 28px;color: #444;padding: 7px 0;font-weight: bolder;">
                            <i class="fa fa-rupee"><a>&nbsp; 1,850 </a></i>
                            <h6>(Inclusive of all taxes)</h6>
                        </div>
                        <div class="col-sm-10" id="amt" style="background: #f3f1f2;font-size: 28px;color: #444;padding: 7px 0;font-weight: bolder; display: none" >
                            <i class="fa fa-rupee"><a>&nbsp; 2,850 </a></i>
                            <h6>(Inclusive of all taxes)</h6>
                        </div>
                         <div class="col-sm-1">
                     ...
                     <div class="row" >
                        <div class="col-sm-1">
                         ...
                         <div class="col-sm-10" style="background: #f3f1f2;font-size: 28px;color: #444;padding: 7px 0;font-weight: bolder;">
                            <i class="fa fa-rupee"><a id="Totalamount2">&nbsp; 3,800 </a></i>
                          <h6>(Inclusive of all taxes)</h6>
