...
<div class="wrapper">
    <nav class="navbar navbar-default navbar-fixed navbar-transparent white bootsnav" style="    background-color: green;">
        <div class="container">
            ...
            <div class="navbar-header"><a class="navbar-brand" href="index.php">
                <div class="hidden-sm hidden-xs hidden-md"><img src="assets/img/logo/log.png"
                                                                                        class="logo logo-display"
                                                                                        alt=""><img
                    src="assets/img/logo/log.png" class="logo logo-scrolled" alt=""></div>
                    <div class="hide-on-desktop"><img src="assets/img/logo/log.png"
                                                                                        class="logo logo-display"
                                                                                        alt=""><img
                    src="assets/img/logo/log.png" class="logo logo-scrolled" alt="" style="height: 65px;margin-top: -21px;width: 100%;"></div>
                    </a></div>
                    <style type="text/css">
    ...
    max-height:0;overflow:hidden;
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
              ...
              <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
                  <li class="dropdown ">
                        <a href="Resumewriting.php" class="dropdown-toggle" data-toggle="dropdown">RESUME SERVICE</a>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-menu col-md-10">
                                        ...
                                        <div class="content">
                                            <ul class="menu-col">
                                                <li><a href="resumeservice.php">Resume Service</a></li>
  ...
  <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
                    <li class="dropdown megamenu-fw" style="float: right;">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="padding-left: 100px;">Browse Jobs</a>
                        <ul class="dropdown-menu megamenu-content" role="menu">
                            <li>
                          <div class="container">
    <div class="tab">
