...
{	
	...
	$insert_customers = "insert into create_resume (name,email,phone,dob,address,education,experience,skill,content) values('$name','$email','$phone','$dob','$address','$education','$experience','$skill','$content')";
						...
						<form method="POST">
							...
							<div class="col-md-12 col-sm-12">
								<div class="input-group">
									...
									<input type="text" class="form-control" placeholder="Location: London UK, Newyork.." name="address">
								</div>	
							</div>
