    ...
    <div class="clearfix"></div>
      ...
      <div id="career-banners" class="xpressbanner">
            <div class="container">
              ...
              <h1 class="seobannerhead"> Get the power of two in one with Career Booster
                    </h1>
                        </div>
                        <div class="banner-bottom-content col-sm-12">
                            <div>
                                (A combo of Right Resume & XpressResume+) </div>
                        </div>
                    </div>
                </div>
            </div>
         ...
         <div class="container-fluid" style="padding:20px">
          <div class="container">
            <h2 class="css_heading mob-h1 fleft">Select & Buy Career Booster in 2 Easy Steps</h2>
            <div class="row">
