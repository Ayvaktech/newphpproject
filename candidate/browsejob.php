                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title">Search Jobs</h3>
                                    <p></p>
                                </div>
                                <div class="card">
...
<input type="text" id="search" placeholder="Search by Job Title" />
  ...
  <div class="search">
<input type="text" id="search1" placeholder="Search By Location" />
 </div>
    <div class="search">
<input type="text" id="search2" placeholder="Search By Category" />
 </div>
