...
$sql=mysqli_query($con,"insert into apply(fname,cname,job_title,number,skill,exp,filename) values('$fname','$cname','$job_title','$number','$skill','$exp','$name')");
                                    ...
                                    <div class="card-body">
                                        <form method="POST" enctype="multipart/form-data">
                                             <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Candidate Name</label>
                                                <input id="inputText3" type="text" class="form-control" name="fname" required>
                                            </div>  
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Company Name</label>
                                                <input id="inputText3" type="text" class="form-control" name="cname" required>
                                            </div>                                         
                                          
                                            
                                            <div class="form-group">
                                                <label for="inputText4" class="col-form-label">Job Title</label>
                                                <input id="inputText4" type="text" class="form-control" placeholder="" name="job_title" required>
                                            </div>
                                              <div class="form-group">
                                                <label for="inputText4" class="col-form-label">Phone Number</label>
                                                <input id="inputText4" type="text" class="form-control" placeholder="" name="number" pattern="[789][0-9]{9}" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputText4" class="col-form-label">Skill</label>
                                                <input id="inputText4" type="text" class="form-control" placeholder="" name="skill" required>
                                            </div>
                                          <div class="form-group">
                                                <label for="inputText4" class="col-form-label">Experience</label>
                                                <input id="inputText4" type="text" class="form-control" placeholder="" name="exp" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputText4" class="col-form-label">Upload Resume</label>
                                                <input id="inputText4" type="file" class="form-control" placeholder="" name="file" required>
                                            </div>
                                            <input type="submit" name="submit" value="Apply" class="btn btn-block btn-primary">
                                        </form>
                                    </div>
