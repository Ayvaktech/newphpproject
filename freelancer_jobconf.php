...
session_start();
                    ...
                    {
                        $id = $_GET['id'];
                        $q = "SELECT * FROM `freelancer_jobapplication` WHERE Freelancer_ID = '$id'";
...
<body>
            ...
            <input type="hidden" name="Freelancer_ID" value="<?php echo $row['Freelancer_ID']; ?>">
...
if(isset($_POST['add']))
{
    ...
    $que = "INSERT INTO `freelancer_jobstatus`(`Freelancer_ID`,`interview_date`,`time`,`address`, `description`) VALUES ('$Freelancer_ID','$dat','$tim','$add','$des')";
    $query5 = mysqli_query($con, $que);
    if($query5)
    {
        $_SESSION["confirm"] =  $Freelancer_ID;
        
        $updatestatus = "UPDATE `freelancer_jobapplication` SET fjobstatus ='completed' WHERE Freelancer_ID='$Freelancer_ID' "; 
