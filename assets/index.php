        ...
        <div class="container">
            ...
            <div class="navbar-header"><a class="navbar-brand" href="index.php">
                <div class="hidden-sm hidden-xs">
                  ...
                  <img src="assets/img/logo/log.png" class="logo logo-scrolled" alt=""></div>
                    <div class="hide-on-desktop">
                      <img src="assets/img/logo/log.png" class="logo logo-display"alt="">
                      <img src="assets/img/logo/log.png" class="logo logo-scrolled" alt="" style="height: 65px;margin-top: -21px;width: 100%;">
                    </div>
                    </a></div>
                    <style type="text/css">
