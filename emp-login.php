            ...
            <section class="login-screen-sec">
                ...
                <div class="alert alert-danger"><b><?php echo $msg ?></b></div><?php }?>
                        <form method="POST">
                            ...
                            <h5 style="text-align: left;font-weight: bold;"><a href="emp_forgot_pass.php">Forgot Password??</a></h5>
                           <div class="col-sm-12 col-md-12">
                            <div class="row">
                               ...
                               <div class="col-sm-6 col-md-6">
                                  <a href="emp_register.php"><input type=""  value="New? Register Here" class="btn btn-login"></a>
                               </div>
                            </div>
...
if(isset($_POST['submit']))
{
 ...
 if($email!=''&&$password!='')
 {
     $q = "SELECT * from `emp_reg` WHERE email='$email' AND password = '$password'";
