            ...
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">View Resume</h5>
                            <div class="card-body">
...
<tr>
<th>
<font face=arial size=4/><?php echo $row['uname'];?></font>
</th>
<th>
<div><a href='../cv/<?php echo $row['filename'];?>'><?php echo $row['filename'];?></a></div>
</th>
<th>
<a href="delete_resume.php?id=<?php echo $row['id'];?>"><i class="fa fa-trash"></i> </a>
</th>
<?php
} 
