...
?>
                                            <tr>
                                                ...
                                                <td><?php   echo $row['url'];  ?> </td>
                                                 <td> <a href="edit_comp.php?id=<?php echo $row['com_id'];?>"><i class="fa fa-edit"></i> </a>  </td> 
                            <td> <a href="delete_comp.php?id=<?php echo $row['com_id'];?>" onclick="return confirm('Are you sure you want to delete this category?.Deleteing this category will loss all your images')" ><i class="fa fa-trash"></i> </a>  </td> 
