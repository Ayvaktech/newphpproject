...
$sql=mysqli_query($con,"UPDATE  comp_reg set cname='$cname', business='$business',number='$number',address='$address',url='$url' where com_id='$id'");
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-4" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="viewcomp.php">View Company</a>
                                        </li>
                             ...
                             <li class="nav-item">
                                ...
                                <div id="submenu-6" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="#">Filter Resume</a>
                                        </li>
                                    </ul>
                                </div>
                            </li> 
            ...
            <div class="container-fluid dashboard-content">
                <div class="row">
                    <div class="col-xl-10">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title">Edit Company Details</h3>
                                    <p></p>
                                </div>
                                <div class="card">
                      ...
                      <?php
    $id=$_GET['id'];
    $sql=mysqli_query($con,"select * from comp_reg where com_id='$id'");
                                        ...
                                        <form method="POST">
                                         <input type="hidden" name="id" value="<?php echo $row['com_id'];  ?>">
                                            <div class="form-group">
                                                ...
                                                <input id="inputText3" type="text" class="form-control" name="cname" value="<?php echo $row['cname']; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputEmail">Nature of Buisness</label>
                                                <input id="inputText3" type="text" placeholder="" class="form-control" name="business" value="<?php echo $row['business']; ?>">
                                               
                                            </div>
                                            <div class="form-group">
                                                <label for="inputEmail">Phone Number </label>
                                                <input id="inputText3" type="text" placeholder="" class="form-control" name="number" value="<?php echo $row['number']; ?>">
                                               
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleFormControlTextarea1">Addresss</label>
                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="address" ><?php echo $row['address']; ?></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputText4" class="col-form-label">URL</label>
                                                <input id="inputText4" type="text" class="form-control" placeholder="" name="url" value="<?php echo $row['url']; ?>">
                                            </div>
