...
if(isset($_POST['submit']))
{
    ...
    $url=$_POST['url'];
$sql=mysqli_query($con,"insert into comp_reg(cname,business,number,address,url) values('$cname','$business','$number','$address','$url')");
                                    ...
                                    <div class="card-body">
                                        <form method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="inputText3" type="text" placeholder="" class="form-control" name="business">
                                               
                                            </div>
                                            <div class="form-group">
                                                <label for="inputEmail">Phone Number </label>
                                                <input id="inputText3" type="text" placeholder="" class="form-control" name="number">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="inputText4" type="text" class="form-control" placeholder="" name="url">
                                            </div>
