                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-4" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="viewcomp.php">View Application</a>
                                        </li>
       ...
       <div class="dashboard-wrapper">
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">View Applications </h2>
                ...
                <div class="row">
                    ...
                    <?php 
     $sql=mysqli_query($con,"select * from apply");
                        ...
                        <div class="card">
                            ...
                            <div class="card-body border-top">
                                <ul class="list-unstyled bullet-check font-14">
                                  <li>Candidate:<?php   echo $row['fname'];  ?></li>
                                    <li>Company: <?php   echo $row['cname'];  ?></li>
                                    <li>Jobtitle: <?php   echo $row['job_title'];  ?></li>
                                    <li>Phone Number: <?php   echo $row['number'];  ?></li>
                                    <li>Skill: <?php   echo $row['skill'];  ?></li>
                                    <li>Experience: <?php   echo $row['exp'];  ?></li>
                                  Resume: <a href='../candidate/upload/<?php echo $row['filename'];?>'><?php echo $row['filename'];?></a>
