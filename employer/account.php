...
$sql=mysqli_query($con,"insert into emp_reg(name,email,password,password1) values('$name','$email','$password','$password1')");
$sql1=mysqli_query($con,"insert into emp_login(name,password) value('$name','$password')");
