                  ...
                  <div class="row text-center">
                     ...
                     <div class="col-sm-5 col-md-5">
                         <select class="form-control">
                             <option class="fresher">0-1 year</option>
                             <option class="experience">1-3 year</option>
                         </select>
                     </div>
                     ...
                     <div class="row" >
                        <div class="col-sm-1">
                         ...
                         <div class="col-sm-10" style="background: #f3f1f2;font-size: 28px;color: #444;padding: 7px 0;font-weight: bolder;">
                            <i class="fa fa-rupee"><a id="Totalamount">&nbsp; 1,850 </a>
                            <a id="Tamt1" style="display: none; ">&nbsp; 2,850 </a></i>
                     ...
                     <div class="row" >
                        <div class="col-sm-1">
                         ...
                         <div class="col-sm-10" style="background: #f3f1f2;font-size: 28px;color: #444;padding: 7px 0;font-weight: bolder;">
                             ...
                             <i class="fa fa-rupee"><a id="Totalamount1">&nbsp; 3,900 </a></i>
                            <h6>(Inclusive of all taxes)</h6>
