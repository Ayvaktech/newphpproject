...
$msg='';
   ...
   if(isset($_POST['submit']))
   {
     ...
     $sel_u = "select * from freelance_register where Email='$email'";
     ...
     if($check_u==0)
     {
       ...
       echo "<script>window.open('freelancer_forgot_pass.php','_self')</script>";
       exit();
     }
     else
     {
  ...
  echo "<script>alert('A New Password Was Sent To Your Email')</script>";
       echo "<script>window.open('new-login-signup.php','_self')</script>";
  }
}
			...
			<section class="login-screen-sec">
                ...
                <div class="alert alert-danger"><b><?php echo $msg ?></b></div><?php }?>
                        ...
                        <div class="col-sm-12 col-md-12">
                            <input type="email" class="form-control" placeholder="Freelancer email" name="email" required="">
                        </div>
                         <div class="col-sm-12 col-md-12">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="row">
                               ...
                               <div class="col-sm-6 col-md-6">
                                  <a href="freelancer_register.php"><input type=""  value="New User? Register Here" class="btn btn-login"></a>
                               </div><br><br><br>
