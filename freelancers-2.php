						...
						<div class="col-md-4 col-sm-6">
							<div class="freelance-container style-2">
								<div class="freelance-box">
                                    ...
                                    <button class="btn btn-freelance-two bg-default"><a href="freelancer-detail.php?id=<?php echo $row['ID'] ?>">View Details</a></button>
                                    <button class="btn btn-freelance-two bg-info"><a href="freelancer-detail.php?id=<?php echo $row['ID'] ?>">View Details</a></button>
