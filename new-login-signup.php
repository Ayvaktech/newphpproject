...
if(isset($_POST['submit']))
{
    ...
    {
        $q = "SELECT * from `freelance_register` WHERE Email= '$email' AND Password='$pass' ";
        ...
        if($row>=1)
        {
            ...
            else if(isset($_SESSION["jobsess"]))
            {
               header('location:job-apply-detail.php'); 
            }
            else
            {
                 $id = $row['ID'];
		...
		<div class="wrapper">  
			...
			<section class="login-screen-sec">
                ...
                <div class="alert alert-danger"><b><?php echo $msg ?></b></div><?php }?>
                        ...
                        <h5 style="text-align: left;font-weight: bold;"><a href="freelancer_forgot_pass.php">Forgot Password??</a></h5>
